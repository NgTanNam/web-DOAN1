        ...
        <div class="container" id="bai_viet" style="top:80px;padding-top:10px">
            ...
            <div id="author_inf">
                ...
                <div id="name_and_time">
                    <div id="name_author">{{auth()->user()->ten}}</div>
                                    ...
                                    <div class="item">
                                        <div class="work">
                                            <div class="img d-flex align-items-center justify-content-center rounded"
                                                style="background-image: url(   {{ asset('uploads/images/'.$item->hinhAnh) }});">
                                                <a href="#"
            ...
            <div><img src="frontend/image/BaiViet/not-favorite-yet.png" width="30px" alt=""> 1280
  ...
  behavior: 'smooth',
    block: "center"
                ...
                updateComment(message) {
                    ...
                    if({{auth()->user()->maNguoiDung}}== message.user_id){
